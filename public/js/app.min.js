...
$(window).on("load", function() {
    ...
    if ($("#data-table")[0]) {
        $("#data-table").DataTable({
            ...
            lengthMenu: [
                [20, 50, 100, -1],
                ["20 Itens", "50 Itens", "100 Itens", "Todos os Itens"]
            ],
            language: {
                searchPlaceholder: "Pesquisar...",
                decimal:        "",
                emptyTable:     "Não há dados disponíveis",
                info:           "Exibindo registros _START_ até _END_ de _TOTAL_",
                infoEmpty:      "Exibindo registros 0 até 0 de 0",
                ...
                aria: {
                    ...
                    sortDescending:  "Ativar ordenação Descencente"
                }
            },
